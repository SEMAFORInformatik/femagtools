...
class AlgorithmTest(unittest.TestCase):
    def test_evolve( self ):
        ...
        F = np.array([ind.cur_f for ind in pop.individuals if ind.rank==0]).T
        ...
        for i in range(25):
            ...
            newpop.eval()
            pop.merge( newpop )
            #print( "znad: {} zi {} zw = {} D {}".format(pop.compute_nadir(), pop.compute_ideal(), pop.compute_worst(), pop.compute_norm_dist() ) )
