...
def test_im():
    ...
    n = f1/p
    udc = 550
    r = femagtools.machine.sizing.im(P, n, udc, p,
                                     sigmas=fs, Ba=0.77,
                                     cos_phi=0.8, eta=0.8,
                                     lda=0.9)
...
def test_spm():
    ...
    r = femagtools.machine.sizing.spm(P, n, udc, p,
                                      Hc=700, sigmas=fs, brem=1.1, Ba=0.77,
                                      cos_phi=0.7, eta=0.8, demag=1.7,
                                      lda=0.9)
    assert round(r['outer_diam'], 3) == 0.176
...
def test_eesm():
    ...
    p = 4
    udc = 600
    r = femagtools.machine.sizing.eesm(P, speed, udc, p, Q1=36)
